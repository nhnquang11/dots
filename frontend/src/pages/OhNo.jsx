    ...
    <>
      <main className="grid min-h-full place-items-center bg-neutral-50 px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="font-serif text-base font-semibold text-neutral-600">401</p>
          <h1 className="font-serif mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Oh no!!!</h1>
          <p className="font-serif mt-6 text-base leading-7 text-neutral-600">This feature is for admin only.</p>
