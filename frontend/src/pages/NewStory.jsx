  ...
  return (
    <div className="flex flex-col justify-center px-3">
      ...
      <div>
        ...
        {
          publishing ? (
            <button id="loading-btn" onClick={publishStory} disabled className="flex items-center justify-center mt-24 sm:mt-16 mb-10 m-auto w-full max-w-xl sm:max-w-2xl text-center px-5 transition duration-200 ease-in-out leading-6 font-serif font-medium py-2 rounded border-0 text-sm bg-neutral-900 text-white hover:bg-neutral-600">
            ...
            <button datatest-id="publish-btn" onClick={publishStory} className="block mt-24 sm:mt-16 mb-10 m-auto w-full max-w-xl sm:max-w-2xl text-center px-5 transition duration-200 ease-in-out leading-6 font-serif font-medium py-2 rounded border-0 text-sm bg-neutral-900 text-white hover:bg-neutral-600">
              Publish
            </button>
          )
        }
