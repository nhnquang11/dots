      ...
      <main className="grid min-h-full place-items-center bg-neutral-50 px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="/"
              className="flex items-center my-14 h-11 font-extralight text-sm font-serif px-5 rounded bg-neutral-900 text-white hover:bg-neutral-600 transition duration-200 ease-in-out"
            >
              Go back home
            </a>
