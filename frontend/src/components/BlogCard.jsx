    ...
    <div className="max-w-2xl">
      ...
      <article className="mt-3">
        <div className="flex items-center gap-x-4 text-xs">
          <time dateTime="2020-03-16" className="font-serif text-gray-500">Mar 16, 2020</time>
          <a href="#" className="font-serif font-medium rounded-full bg-gray-100 px-3 py-1.5 text-gray-700 hover:bg-gray-200">Typology</a>
        </div>
        <div>
          <h3 className="font-serif mt-3 text-lg leading-6 font-semibold text-gray-900 group-hover:text-gray-600">
            <a href="#">
              Trực giác hướng nội
            </a>
          </h3>
          <p className="font-serif mt-4 line-clamp-3 text-sm leading-6 text-gray-600">Trong khoảnh khắc, mọi người coi chúng tôi là điên rồ hoặc ngu ngốc. Họ không thấy cách chúng tôi nhìn thấy bức tranh toàn cảnh, sự kết nối tổng thể của thông tin và kết luận cuối cùng. Nhưng một khi họ làm được, muộn hơn rất nhiều, họ sẽ thấy tất cả các mảnh ghép ăn khớp như thế nào, và tại sao chúng tôi chơi tàn cuộc, và thực hiện nước chiếu tướng. Chúng tôi không chính xác và rõ ràng, nhưng chúng tôi có thể xấp xỉ với kết quả đó.</p>
          <p className="font-serif mt-4 text-xs text-gray-500">10 min read</p>
        </div>
      </article>
    </div>
  )
