  ...
  return (
    <div className="flex flex-col items-center mt-16 lg:mt-20">
      <div className="flex justify-between items-center gap-x-4">
        <div className="px-6 font-serif text-neutral-900">6 articles</div>
        <button className="flex items-center leading-10 font-serif text-neutral-900 px-6 rounded-full transition duration-200 ease-in-out hover:bg-neutral-200 focus:bg-white border border-transparent focus:border-neutral-500">
          Filter
